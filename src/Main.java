...
public class Main {
    public static void main(String[] args) {
        ...
        /*Attribute outlook = new Attribute(3, new String[]{"Sunny", "Rain", "Overcast"}, "Outlook");
        Attribute temp = new Attribute("Temp");
        Attribute humidity = new Attribute("Humidity");
        Attribute wind = new Attribute(2, new String[]{"Weak", "Strong"}, "Wind");
        Attribute classAtt = new Attribute(2, new String[]{"No", "Yes"}, "Class");
        String dataFile = "weather.csv";
        C45Tree c45Tree = new C45Tree(dataFile, new Attribute[]{outlook, temp, humidity, wind, classAtt}, 14, false,true, 10);*/
